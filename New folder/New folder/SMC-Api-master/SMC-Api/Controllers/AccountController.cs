...
using SMC_Api.Providers;
using SMC_Api.Results;
    ...
    public class AccountController : ApiController
    {
        ...
        public IEnumerable<RegisterBindingModel> GetUsers(int storeId)
        {
           //var currentUser = System.Web.HttpContext.Current.User.Identity;
            var users = userService.GetUsers(storeId);
        ...
        [AllowAnonymous]
        [Route("Delete")]
        public async Task<IHttpActionResult> Delete(RegisterBindingModel model)
        {
